...
**开工前置依赖增补**：M0’/Round 5 裁决（ADR-0007）后，本文件 §5.2 的  Wunderground 职责条款与 ADR-0007 D2 存在冲突。启动 Phase 2 开发前，  须先完成《项目方案 v2.5》§8.1 三条 ADR 条目（结算真值源 / 切换窗阈值 /  特报语义）的裁决。裁决完成前，本文件保持 v1.3 Final 原状，不得据此开发。
